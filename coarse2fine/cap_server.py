...
from cap_inference import build, infer

## load model 
var, vae, normalizer = build(ckpt_pth = "/home/robot/UR_Robot_Arm/coarse2fine/ckpt/ar-ep_4000-accmean_29.68-acctail_32.00.pth")
n_obs_steps = 1
n_action_steps = 8
...
def predict():
    try:
        ...
        # send back
        response = {
            "actions": action_quat.tolist()  # numpy 数组转换为列表，以便序列化为 JSON
        }
