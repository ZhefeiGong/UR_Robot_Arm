...
class AmpOptimizer:
    """
    @func : Automatic Mixed Precision, AMP
    @info : 
    ...
    def backward_clip_step(
        ...
        """
        @func : returns a state dictionary for the optimizer and scaler
    ...
    def state_dict(self):
        """
        @func : return a state dictionary for the optimizer and scaler
    ...
    def load_state_dict(self, state, strict=True):
        """
        @func : load the state of the optimizer and scaler and resume the training progress
